...
public class ModItems {
    ...
    public static final Supplier<Item> RADISH = registerWithTab("radish",
            ()-> new ItemNameBlockItem(ModBlocks.RADISH_CROP.get(), foodItem(FoodValues.RADISH)));
    public static final Supplier<Item> CUCUMBER_SEEDS = registerWithTab("cucumber_seeds",
            () -> new ItemNameBlockItem(ModBlocks.CUCUMBER_CROP.get(), basicItem()));
    ...
    public static final Supplier<Item> SAUERKRAUT = registerWithTab("sauerkraut",
            ()-> new ConsumableItem(bowlFoodItem(FoodValues.SAUERKRAUT)));
